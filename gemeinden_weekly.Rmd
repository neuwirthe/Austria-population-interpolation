...
`R_MAX_VSIZE=128Gb` on a machine with 64Gb of real memory, and it took about 45 minutes.
...
```{r}
pop_GKZ_1y_gender_weekly |> 
  select(-Jahr_Woche,-Quartal,-Wochen_im_Quartal) |>
  select(Datum:Geschlecht,pop,Name) ->
  pop_GKZ_1y_gender_weekly
```
