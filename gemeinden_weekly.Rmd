...
Setting `GKZ_to_use` fo a vector of Gemeindekennzahlen (within this file or in an other fulr purling this file) will produce the result only for the selected Gemeinden.
